 ...
 * Generated at: 2022-12-06 02:16:27 UTC
...
public final class feedAdd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("dao.FeedDAO.BbsDAO");
...
//            String value = item.getString(); 
    ...
    if (dao.insert(uid, ucon, ufname)) {
      ...
      out.write("\r\n");
      out.write("\r\n");
      dao.UserBean bbs = null;
      bbs = (dao.UserBean) _jspx_page_context.getAttribute("bbs", javax.servlet.jsp.PageContext.PAGE_SCOPE);
      if (bbs == null){
        bbs = new dao.UserBean();
      ...
      out.write("	");
		...
		if(userID==null){
			...
			script.println("</script>");	
				...
				FeedDAO bbsDAO = new FeedDAO();
				int result = FeedDAO.delete(bbsID);
				if(result==-1){
					PrintWriter script= response.getWriter();
					script.println("<script>");
					...
					PrintWriter script= response.getWriter();
					script.println("<script>");
					script.println("location.href='feedAdd.jsp'");
					script.println("</script>");
			}
		}
